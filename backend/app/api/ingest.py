...
class IngestionPipeline:
    ...
    def ingest_folder(self, folder_path: str):
        """
        Process all PDF files in a folder and create chunks.
        """
        ...
        for pdf_file in pdf_files:
            ...
            # Step 3: Split into individual KB articles
    ...
    def upload_chunks(
        ...
        """
        Generate embeddings and upload chunks to Pinecone in batches.
        """
    ...
    def ingest_and_upload(
        ...
        PDF -> Clean -> Articles -> Chunks -> Embeddings -> Pinecone
        """
